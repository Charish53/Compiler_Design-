/*Given a CFG which is LL(1) as an input file where each line has exactly one or two production rules, Write a C program to construct and print the LL(1) parsing table. 

Note: (Nonterminals -Capital letters, Terminals - small letters, and epsilon (ε) - #).

  Your program should work for any CFG which is LL(1).
